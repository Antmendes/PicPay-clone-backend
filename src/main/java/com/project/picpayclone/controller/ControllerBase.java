...
public abstract class ControllerBase<T> {   // o T como generic permite que seja passada qualquer classe

	// classe generica, pode ser aproveitada em outros projetos
